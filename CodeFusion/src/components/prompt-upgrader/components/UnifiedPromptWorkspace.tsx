...
const UnifiedPromptWorkspace: React.FC<UnifiedPromptWorkspaceProps> = ({
  ...
  return (
    <div
      className={`rounded-3xl border-2 shadow-2xl transition-all duration-500 transform hover:scale-[1.002] min-h-[70vh]
    ...
    >
      ...
      <div
        className={`px-8 py-6 border-b-2 transition-all duration-500 ${getGradientBackground(
          "accent"
        )}
                     ${
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="relative">
              <div
                className={`p-4 rounded-2xl shadow-lg transition-all duration-300 transform hover:scale-110
                             ${
                               darkMode
              ...
              <div
                className={`absolute inset-0 rounded-2xl border-2 opacity-20 animate-pulse
                             ${
            ...
            <div className="space-y-2">
              ...
              >
                Transform your prompts with intelligent analysis and advanced
                enhancement
              </p>
            </div>
          </div>
          ...
          <button
            onClick={() =>
              onParamsChange({ prevent_lists: !upgradeParams.prevent_lists })
            }
          ...
          >
            <FaRocket />
            <span>
              {upgradeParams.prevent_lists ? "No Lists" : "Allow Lists"}
            </span>
          </button>
          ...
          <div className="flex items-center space-x-4">
            {selectedPrompt && (
              <div
                className={`px-4 py-2 rounded-full font-medium shadow-lg backdrop-blur-sm
                             ${
                               darkMode
      ...
      <div className="p-8 space-y-8">
        <div
          className={`grid gap-8 transition-all duration-500 ${
            upgradedPrompt ? "lg:grid-cols-2" : "lg:grid-cols-1"
          }`}
        >
                  ...
                  <div className="flex items-center space-x-3 mt-1">
                    <span
                      className={`text-sm font-medium px-3 py-1 rounded-full
                                    ${getTokenCountColor(
                                      estimateTokenCount(inputPrompt)
                                    )} 
                                    ${
                                      darkMode
                                        ? "bg-dark-700/50"
    ...
    ${
      darkMode
          ...
          {upgradedPrompt && (
            <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-3 mt-1">
                      ...
                      >
                        {estimateTokenCount(upgradedPrompt).toLocaleString()}{" "}
                        tokens
                      </span>
                      <span
                        className={`text-xs px-2 py-1 rounded-full font-medium
              ...
              <div className="relative group">
                ...
                />
                <div
                  className={`relative p-6 rounded-2xl border-2 font-mono text-sm whitespace-pre-wrap overflow-y-auto leading-relaxed
                               ${expandedOutput ? "max-h-[32rem]" : "max-h-80"}
                               ${
                                 focusedSection === "output"
                                   ? "scale-[1.01] shadow-2xl"
                                   : "shadow-lg"
                               }
                               ${
              ...
              {inputPrompt && (
                <div
                  className={`p-6 rounded-2xl shadow-lg ${getGradientBackground(
                    "secondary"
                  )}`}
                >
                  <h4
                    className={`font-bold text-lg mb-4 flex items-center space-x-3
                                ${
                                  darkMode ? "text-dark-100" : "text-gray-900"
                                }`}
                  >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      ...
                      <div
                        key={index}
                        className={`p-4 rounded-xl text-center transition-all duration-300 hover:scale-105 shadow-lg
                                                 ${
                                                   darkMode
        ...
        {showSettings && (
          <div
            className={`mt-10 pt-8 border-t-2 transition-all duration-500 ${getGradientBackground(
              "secondary"
            )}
                         ${
                           darkMode
