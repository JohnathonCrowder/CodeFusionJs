...
vi.mock("react-icons/fa", () => ({
  ...
  FaCodeBranch: ({ className }: { className?: string }) => (
    <span data-testid="git-diff-icon" className={className}>
      GitDiffIcon
    </span>
  ),
}));
...
describe("NavBar Component", () => {
  ...
  const renderNavBarWithTheme = (darkMode = false) => {
    return render(
      <ThemeContext.Provider
        value={{ darkMode, toggleDarkMode: mockToggleDarkMode }}
      >
        <NavBar
  ...
  describe("Rendering", () => {
    ...
    it("should render all navigation items", () => {
      ...
      expect(
        screen.getByRole("button", { name: /git diff/i })
      ).toBeInTheDocument();
      expect(
  ...
  describe("Navigation Functionality", () => {
    ...
    it("should handle undefined onGitDiffOpen gracefully", () => {
      render(
        <ThemeContext.Provider
          value={{ darkMode: false, toggleDarkMode: mockToggleDarkMode }}
        >
          <NavBar onHelpOpen={mockOnHelpOpen} onAboutOpen={mockOnAboutOpen} />
        </ThemeContext.Provider>
      );
  ...
  describe("Styling and Layout", () => {
    ...
    it("should render bottom border gradient", () => {
      ...
      const bottomGradient = container.querySelector(
