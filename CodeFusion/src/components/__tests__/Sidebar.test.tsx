...
import Sidebar from "../directory_converter/Sidebar";
...
vi.mock("react-icons/fa", () => ({
  ...
  FaEraser: ({ className }: { className?: string }) => (
    <span data-testid="eraser-icon" className={className}>
      EraserIcon
    </span>
  ),
...
describe("Sidebar Component", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should display file count badge", () => {
      ...
      const fileCountBadge = allTwos.find(
        (element) =>
          element.classList.contains("bg-gray-100") ||
          element.classList.contains("bg-dark-600")
      );
  ...
  describe("Button Functionality", () => {
    ...
    it("should highlight Smart Analysis button when analyzer is shown", () => {
      ...
      const analysisButton = screen
        .getByText("Smart Analysis")
        .closest("button");
  ...
  describe("File Tree", () => {
    ...
    it("should apply proper styling to folders", () => {
      ...
      const folderIcon = folderElement?.querySelector(
  ...
  describe("Skipped Files", () => {
    it("should display skipped files section", () => {
      ...
      const allTwos = screen.getAllByText("2");
      const skippedBadge = allTwos.find(
        (element) =>
          element.classList.contains("bg-orange-100") ||
          element.classList.contains("bg-orange-900/30")
      );
  ...
  describe("Scrolling", () => {
    it("should have scrollable file list area", () => {
      ...
      const uploadedFilesSection = screen
