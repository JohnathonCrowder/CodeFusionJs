...
import { UpgradePrompt, SubscriptionModal } from "../modals/subscription";
  ...
  return (
    <ul
      className={`space-y-0.5 ${
        level > 0 ? "ml-2 sm:ml-3 border-l pl-2 sm:pl-3" : ""
      } 
                  ${
                    level > 0
                      ? darkMode
      ...
      {filteredFiles.map((file, index) => {
        ...
        return (
          <li key={file.path || index} className="select-none">
            <div
              className={`group flex items-center justify-between py-1.5 px-2 rounded-lg w-full
            ...
            >
              ...
              >
                <div className="flex-shrink-0 flex items-center">
                  ...
                  {hasChildren ? (
                    <FaFolder
                      className={`mr-1.5 h-3.5 w-3.5 sm:h-4 sm:w-4 flex-shrink-0 transition-colors duration-200
                                       ${
                                         file.visible
                                           ? isExpanded
                                             ? darkMode
                ...
                <span
                  className={`text-xs sm:text-sm font-medium truncate overflow-ellipsis max-w-full transition-colors duration-200
                               ${
                                 file.visible
                                   ? darkMode
                                     ? "text-dark-200"
...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const handleFileUploadWithTracking = async (
  ...
  const handleDirectoryUploadWithTracking = async (
    event: React.ChangeEvent<HTMLInputElement>
  ) => {
    const files = event.target.files;
    if (!files || !userProfile) return;
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex items-center justify-between p-4 sm:p-6 border-b transition-all duration-300 flex-shrink-0
      ...
      >
        ...
        {uploadError && (
          <div
            className={`mx-3 sm:mx-4 mb-4 p-3 rounded-lg border-l-4 transition-colors duration-300
                         ${
                           darkMode
        ...
        {showUpgradePrompt && !isPremium && (
          <div className="p-3 sm:p-4">
            <UpgradePrompt
              feature={
                upgradeFeature === "ai-insights"
                  ? "AI Code Insights"
                  : upgradeFeature === "project-history"
                  ? "Project History"
                  : "Premium Features"
              }
          ...
          <div className="p-3 sm:p-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  {fileStats.visibleFiles < fileStats.totalFiles && (
                    ...
                    >
                      ...
                      <span>
                        {fileStats.totalFiles - fileStats.visibleFiles} hidden
                      </span>
                    </button>
                  )}
                </div>
            ...
            {uploadedFiles.length > 0 && (
              <>
                ...
                {/* File Tree */}
                <div
                  className={`rounded-lg border transition-colors duration-300 max-h-[500px] overflow-auto
                               ${
                                 darkMode
            ...
            {uploadedFiles.length === 0 && (
              <div
                className={`text-xs sm:text-sm text-center py-8 rounded-lg border-2 border-dashed
                             ${
                               darkMode
          ...
          <div className="p-3 sm:p-4">
            ...
            {showSkippedFiles && (
              <div className="mt-3">
                {skippedFiles.length > 0 ? (
                  <div
                    className={`rounded-lg border max-h-40 overflow-y-auto
                                 ${
                                   darkMode
                                     ? "bg-dark-700 border-dark-600"
                                     : "bg-gray-50 border-gray-200"
                    ...
                    <div className="p-2 sm:p-3 space-y-1.5">
                      {skippedFiles.map((file, index) => (
                        ...
                        >
                          ...
                          <span
                            className={`text-xs ml-2 flex-shrink-0 px-2 py-0.5 rounded
                                          ${
                                            darkMode
                  ...
                  <div
                    className={`text-xs sm:text-sm text-center py-4 rounded-lg
                                 ${
                                   darkMode ? "text-dark-400" : "text-gray-500"
                                 }`}
                  >
      ...
      {isMobile && fileStats.totalFiles > 0 && (
        <div
          className={`p-3 border-t flex items-center justify-around text-xs flex-shrink-0
                       ${
                         darkMode
