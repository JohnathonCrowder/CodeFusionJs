...
const MainContent: React.FC<MainContentProps> = ({
  ...
  return (
    ...
    >
      ...
      {fileData.length > 0 && (
        <div
          className={`border-b transition-colors duration-300 flex-shrink-0
                       ${
                         darkMode
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between min-w-0">
            ...
            <div className="flex items-center justify-between px-3 py-2 sm:py-3 min-w-0">
              <div className="flex items-center min-w-0">
                <button
                  ...
                  className={`p-2 rounded-lg transition-all duration-200 mr-2 flex-shrink-0
                            ${
                              darkMode
                                ? `bg-${
                                    showSearch ? "accent-500/20" : "dark-700"
                                  } text-${
                                    showSearch ? "accent-400" : "dark-300"
                                  }`
                                : `bg-${
                                    showSearch ? "blue-50" : "gray-100"
                                  } text-${
                                    showSearch ? "blue-600" : "gray-500"
                                  }`
                            }`}
                >
                ...
                <div
                  className={`text-xs sm:text-sm transition-colors duration-300 overflow-hidden
                             ${darkMode ? "text-dark-400" : "text-gray-500"}`}
                >
                  <span className="hidden sm:inline">Press </span>
                  <kbd
                    className={`px-1 py-0.5 mx-1 rounded text-xs font-mono
                                 ${
                                   darkMode
              ...
              <div className="flex items-center space-x-1 sm:space-x-3 text-xs flex-shrink-0">
                <span
                  className={`hidden sm:inline px-2 py-1 rounded-full whitespace-nowrap
                                ${
                                  darkMode
            ...
            <div className="flex items-center justify-end space-x-2 px-3 pb-2 sm:pb-0 sm:pr-3 flex-shrink-0">
              ...
              {isAnonymized && (
                <div
                  className={`flex items-center space-x-1 px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg font-medium text-xs sm:text-sm whitespace-nowrap
                               ${
                                 darkMode
      ...
      <div className="flex-1 p-2 sm:p-4 md:p-6 relative min-w-0 overflow-hidden">
        {fileData.length > 0 ? (
          <div className="h-full flex flex-col min-w-0">
            ...
            <div
              className={`flex-1 relative rounded-lg md:rounded-xl border transition-all duration-300 min-w-0 overflow-hidden
                           ${
                             darkMode
            ...
            >
              ...
              <div
                className={`flex items-center justify-between p-2 sm:p-3 border-b flex-shrink-0
                             ${
                               darkMode
              ...
              >
                ...
                {/* File count badge */}
                <div
                  className={`flex items-center text-xs space-x-1.5 flex-shrink-0
                               ${darkMode ? "text-dark-400" : "text-gray-500"}`}
                >
              ...
              <div className="relative flex-1 overflow-hidden">
                ...
                {searchMatches.length > 0 && !isSearchExpanded && (
                  <div
                    className={`absolute bottom-4 right-4 flex items-center space-x-2 p-1.5 rounded-lg shadow-lg z-10
                                 ${
                                   darkMode
                  ...
                  >
                    ...
                    <button
                      onClick={() =>
                        setCurrentMatchIndex(
                          (prev) => (prev + 1) % searchMatches.length
                        )
                      }
                      className={`p-1.5 rounded-md transition-colors
                                ${
            ...
            {isAnonymized && (
              <div
                className={`mt-3 md:mt-4 p-3 md:p-4 rounded-lg border-l-4 text-xs sm:text-sm flex-shrink-0
                             ${
                               darkMode
          ...
          <div className="h-full flex items-center justify-center px-4 min-w-0">
            <div
              className={`text-center p-6 sm:p-8 md:p-12 rounded-xl md:rounded-2xl transition-all duration-300 w-full max-w-md
                           ${
                             darkMode
            ...
            >
              ...
              <div className="mb-4 sm:mb-6 md:mb-8">
                <div
                  className={`w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto rounded-full flex items-center justify-center
                               ${
                                 darkMode
                ...
                >
                  <FaUpload
                    className={`h-7 w-7 sm:h-8 sm:w-8 md:h-10 md:w-10 transition-colors duration-300
                                       ${
                                         darkMode
                                           ? "text-dark-400"
                                           : "text-gray-400"
              ...
              {/* Empty State Content */}
              <h3
                className={`text-xl sm:text-2xl font-bold mb-2 sm:mb-3 md:mb-4 transition-colors duration-300
              ...
              <p
                className={`text-sm sm:text-base mb-6 md:mb-8 max-w-md mx-auto leading-relaxed
                           ${darkMode ? "text-dark-300" : "text-gray-600"}`}
              >
                Upload files or a directory using the sidebar controls to begin
                viewing your code.
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4 max-w-lg mx-auto">
                ...
                >
                  <FaFile
                    className={`h-5 w-5 md:h-6 md:w-6 mx-auto mb-1 md:mb-2
                                     ${
                                       darkMode
                                         ? "text-accent-400"
                                         : "text-blue-600"
              ...
              {isAnonymized && (
                <div
                  className={`mt-6 p-3 sm:p-4 rounded-lg transition-colors duration-300
                               ${
                                 darkMode
